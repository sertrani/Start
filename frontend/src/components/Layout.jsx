...
import { Car, LogOut, LayoutGrid, CalendarDays, Grid3x3, Settings as SettingsIcon } from "lucide-react";
        ...
        <div className="px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="font-heading text-base font-extrabold text-slate-900 leading-none truncate">
                {company}
              </p>
          ...
          <div className="flex items-center gap-2">
            <span className="hidden md:block text-sm text-slate-500 mr-1">{user?.email}</span>
            <Button
              variant="ghost"
              size="sm"
